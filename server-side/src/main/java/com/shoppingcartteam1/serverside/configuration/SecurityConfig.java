...
import com.shoppingcartteam1.serverside.security.JwtAuthEntryPoint;
import com.shoppingcartteam1.serverside.security.JwtAuthFilter;
	...
	public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
		http.csrf(csrf -> csrf.disable()).cors(cors -> cors.disable()).cors(cors -> cors.disable())
				.authorizeHttpRequests(auth -> auth.requestMatchers("/home/**").permitAll()
						...
						.requestMatchers("current-user").permitAll().anyRequest().permitAll())
